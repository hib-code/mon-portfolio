    ...
    <div className="flex flex-col xl:flex-row items justify-between xl:pt-8 xl:gb-24">
      <div className="text-center xl:text-left order-2 xl:order-none">
        ...
        <p className="max-w-[500px] mb-9 text-white/80">
          J'excelle dans la création d'applications web
           complètes et élégantes, en maîtrisant à la fois le 
           développement front-end et back-end, ainsi que divers 
           langages et technologies de programmation.</p>
